                            ...
                            <div className="space-y-4 md:space-y-6">
                                <div className='flex flex-col md:flex-row md:justify-between gap-4'>
                                    <div className='w-full md:w-1/2'>
                                        ...
                                        <input ref={(i) => fname = i} type="text" name="fname" id="fname" className=" border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-[#0C7075] focus:border-[#0C7075] block w-full p-2.5 " placeholder="e.g. John" required="" />
                                    </div>
                                    <div className='w-full md:w-1/2'>
